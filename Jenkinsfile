...
stage ("Build") {
  ...
  node {
    ...
    checkout([ $class: 'GitSCM',
               ...
               extensions: [
                 [ $class: 'RelativeTargetDirectory',
                   relativeTargetDir: 'ableC_Home/extensions/edu.umn.cs.melt.exts.ableC.algebraicDataTypes']
               ],
               submoduleCfg: [],
               userRemoteConfigs: [
    ...
    withEnv(["PATH=${SILVER_BASE}/support/bin/:${env.PATH}"]) {
      sh "cd ableC_Home/extensions/edu.umn.cs.melt.exts.ableC.algebraicDataTypes/artifact && ./build.sh"
    }
  }
...
stage ("Modular Analyses") {
  node {
    withEnv(["PATH=${SILVER_BASE}/support/bin/:${env.PATH}"]) {
      def mdir = "ableC_Home/extensions/edu.umn.cs.melt.exts.ableC.algebraicDataTypes/modular_analyses"
...
stage ("Test") {
  node {
    def top_dir = "ableC_Home/extensions/edu.umn.cs.melt.exts.ableC.algebraicDataTypes"
