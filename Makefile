...
EXT_NAME=ableC-algebraic-data-types
EXT_GRAMMAR=edu:umn:cs:melt:exts:ableC:algebraicDataTypes
# ableC-templating is only used in the test suite, it is not needed by downstream extensions.
EXT_DEPS=ableC-string ableC-constructor ableC-allocation ableC-templating
USE_CUSTOM_SILVER=1
